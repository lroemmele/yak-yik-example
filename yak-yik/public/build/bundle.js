...
var Zones = function (_Component) {
     ...
     function Zones(props) {
          ...
          _this.state = {
               list: [{ name: 'Zone 1', zipCode: '12345', numComments: 10 }, { name: 'Zone 2', zipCode: '12346', numComments: 20 }, { name: 'Zone 3', zipCode: '12346', numComments: 20 }]
          };
          return _this;
     }
...
var Comments = function (_Component) {
     ...
     function Comments(props) {
          ...
          _this.state = {
               list: [{ body: 'comment 1', username: 'guy1', timestamp: '10:00' }, { body: 'comment 2', username: 'guy2', timestamp: '11:00' }, { body: 'comment 3', username: 'guy3', timestamp: '12:00' }, { body: 'comment 4', username: 'guy4', timestamp: '01:00' }]
          };
          return _this;
     }
